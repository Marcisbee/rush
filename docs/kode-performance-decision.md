...
| --- | --- | ---: | --- | ---: | ---: | --- |
| Vitest/jsdom fresh process | 1,578.1; 1,612.6; 1,600.8; 1,598.8; 1,619.2 | 1,600.8 ms | 1,618.9; 1,613.2; 1,587.9; 1,585.8; 1,575.3 | 1,587.9 ms | baseline | pass |
| Rush, same 100 tests | 1,647.0; 1,376.5; 1,308.1; 1,453.8; 1,592.4 | 1,453.8 ms | 200.2; 311.3; 351.8; 423.8; 468.4 | 351.8 ms | at most 158.8 ms (10×) | **failed: 4.5×** |
| Rush warm 100-test repeat | 1,661.3; 1,996.2; 2,408.6; 2,138.3; 2,112.7 | 2,112.7 ms | 524.0; 627.4; 640.8; 735.5; 713.9 | 640.8 ms | under 1,000 ms | **pass** |

All 100 tests passed in every sample. The rework reduced the representative median by 76% and the independent warm median by 70%.
